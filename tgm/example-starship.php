...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
			...
			'source'             => get_stylesheet_directory() . '/lib/plugins/unyson.2.4.16.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '2.4.16.', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			...
			'is_callable'        => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
                ...
                array(
			'name'               => 'FV Top Level Categories', // The plugin name.
			'slug'               => 'fv-top-level-categories', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/fv-top-level-cats.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
